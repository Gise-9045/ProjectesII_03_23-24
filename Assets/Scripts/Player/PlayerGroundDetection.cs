...
public class PlayerGroundDetection : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            if(collider.CompareTag("Ground") || collider.CompareTag("ColorChange")|| collider.CompareTag("PuzzleBox") || collider.CompareTag("Ladder") || collider.CompareTag("Button")|| collider.CompareTag("Hazards"))
            {
